...
let rootUrl = URL(string: "https://www.lyyildirimlarinsaat.com/?source=ios")!

// allowed origin is for what we are sticking to pwa domain
// This should also appear in Info.plist
let allowedOrigins: [String] = ["www.lyyildirimlarinsaat.com", "lyyildirimlarinsaat.com"]

// auth origins will open in modal and show toolbar for back into the main origin.
// These should also appear in Info.plist
let authOrigins: [String] = ["lyyildirimlarinsaat.com", "www.lyyildirimlarinsaat.com"]
